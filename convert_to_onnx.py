...
def main():
    ...
    parser.add_argument('--input', '-i', default='data/model_best.pth', help='Input PyTorch model path')
    parser.add_argument('--output', '-o', default='data/model_best.onnx', help='Output ONNX model path')
    parser.add_argument('--force', '-f', action='store_true', help='Force overwrite existing ONNX model')
