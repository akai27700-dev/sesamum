...
class StartupSettingsDialog:
    def __init__(self, parent, cpp_available):
        ...
        self._add_radio_group(frame, "定石", self.book_source, [("OFF", "off"), ("Egaroucid", "egaroucid"), ("JSON", "json")])
    ...
    def on_ok(self):
        ...
        source = self.book_source.get()
        # OFF時のみ0%、それ以外は100%
        book_usage_pct = 0 if source == "off" else 100
